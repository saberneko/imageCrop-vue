class Clip {
  ...
  panitImg (imgUrl) {
    ...
    img.onload = function () {
      ...
      let boxScale = t.container.offsetWidth / t.container.offsetHeight
  ...
  saveImg () {
    ...
    img.onload = function () {
      ...
      let cropHeightScale = img.height / t.imgHeight

      ctx.drawImage(img, cropWidthScale * t.sx, cropHeightScale * t.sy,
        cropWidthScale * t.sWidth, cropHeightScale * t.sHeight, 0, 0, 300, 300)
